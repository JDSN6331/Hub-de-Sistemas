...
echo ============================================
echo   Instalador do Servico - Hub de Sistemas
echo ============================================
echo.
...
:: Compilar versao mais recente antes de registrar
echo [INFO] Compilando versao de producao (npm run build)...
cd /d "%APP_DIR%"
call npm run build
...
"%NSSM_EXE%" set %SERVICE_NAME% DisplayName "Hub de Sistemas Agro - Servidor Web"
"%NSSM_EXE%" set %SERVICE_NAME% Description "Servidor Web para a central Hub de Sistemas do Departamento de TI Agro (Porta 5174)"
...
echo.
echo Acesse o Hub de Sistemas em:
echo   http://localhost:5174 (neste computador)
echo   ou
echo   http://^<IP_DO_NOTEBOOK^>:5174 (outros computadores da rede)
echo.
